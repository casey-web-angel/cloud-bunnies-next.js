  ...
  return (
    <div id="map" className='md:my-16'>
      ...
      <div className='flex flex-col relative'>
        <div className="absolute left-4 md:left-[47.5%]  bg-white w-2 md:w-4 rounded-md h-full md:h-[97%] mt-3"></div>
        ...
        <MapItem inverse={false} id="05]" title="Secret airdrop for holders" desc="Not going to reveal too much details on this as we want to surprise our cloud bunnies NFT holders with airdrops! " />      </div>
    </div>
  )
}
