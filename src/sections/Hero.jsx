...
function Hero() {
  return (
    <div id="home" className="h-[90vh] relative w-screen bg-hero_mobile md:bg-hero bg-no-repeat relative  md:bg-bottom bg-center  bg-cover">
      ...
      <div className='md:max-w-[25%] max-w-[60%] w-full flex absolute items-center top-[60%] left-[23%] md:top-[65%] mx-auto'  data-aos='fade-up' >
        <button className="bg-button bg-center py-2 md:py-3 bg-cover w-full text-white uppercase text-lg md:text-xl font-irish border-none rounded-full ">Explore Bunny</button>
      </div>
    </div>
  )
}
